...
import com.example.mac_os.criminalintent.datebase.crimeDbSchema;
...
public class CrimeLab {
        ...
        try {
            if (cursor.getCount() >= 0) {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    Crime crime = getCrimeByCursor(cursor);
                    crimes.add(crime);
                    cursor.moveToNext();
                }
            }
    ...
    @NonNull
    private Crime getCrimeByCursor(Cursor cursor) {
